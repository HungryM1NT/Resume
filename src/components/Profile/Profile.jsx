    ...
    <section className="info card" data-aos={aos}>
      <div className="content">
        ...
        <div className="text">
          ...
          <p>
            Студент второго курса МТУСИ. Направление "Информатика и
            вычислительная техника", профиль "Искусственный интеллект и машинное
            обучение". Развитие в области web-разработки. Стремление к изучению
            нового материала.
          </p>
        </div>
